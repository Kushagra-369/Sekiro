...
import '../components/Scroll.css'; // Optional custom styles
...
export default function Gallery() {
  ...
  return (
    <Element name="gallery">
      <div className="w-full min-h-screen"             style={{ scrollBehavior: "smooth", background: ' url(https://c4.wallpaperflare.com/wallpaper/310/302/397/sekiro-shadows-die-twice-samurai-video-games-video-game-art-watermarked-hd-wallpaper-preview.jpg)', backgroundSize: "cover", backgroundRepeat: "no-repeat", minHeight: '100vh' }}
>
        {/* Header */}
        ...
        <div className="h-screen w-full py-20 ">
          <Swiper
            ...
            loop={true}
            className=" h-100 w-90 md:w-250 md:h-100 "
          >
            {data.map((item) => (
